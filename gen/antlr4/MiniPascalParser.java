...
public class MiniPascalParser extends Parser {
	...
	public static final int
		BEGIN=1, END=2, WS=3, COMMENT=4, INTEGER=5, CHAR=6, STRING=7, ASSIGN=8, 
		PLUS=9, MINUS=10, DIV=11, MULT=12, MOD=13, AND=14, NOT=15, OR=16, GT=17, 
		LT=18, LE=19, GE=20, EQUAL=21, NOT_EQUAL=22, L_PAREN=23, R_PAREN=24, L_BRACK=25, 
		R_BRACK=26, COMMA=27, SEMICOLON=28, COLON=29, DOT=30, DOUBLE_DOT=31, PROGRAM=32, 
		FUNCTION=33, PROCEDURE=34, IF=35, THEN=36, ELSE=37, UNTIL=38, WHILE=39, 
		FOR=40, REPEAT=41, TO=42, DO=43, DOWNTO=44, VAR=45, TRUE=46, FALSE=47, 
		ARRAY=48, OF=49, INTEGER_=50, BOOLEAN_=51, CHAR_=52, STRING_=53, NIL=54, 
		CONST=55, CHR=56, AT=57, READLN=58, READ=59, WRITELN=60, WRITE=61, ID=62;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'begin'", "'end'", null, null, null, null, null, "':='", "'+'", 
			"'-'", null, "'*'", "'mod'", "'and'", "'not'", "'or'", "'>'", "'<'", 
			"'<='", "'>='", "'='", "'<>'", "'('", "')'", "'['", "']'", "','", "';'", 
			"':'", "'.'", "'..'", "'program'", "'function'", "'procedure'", "'if'", 
			"'then'", "'else'", "'until'", "'while'", "'for'", "'repeat'", "'to'", 
			"'do'", "'downto'", "'var'", "'true'", "'false'", "'Array'", "'of'", 
			"'INTEGER'", "'BOOLEAN'", "'CHAR'", "'STRING'", "'NIL'", "'CONST'", "'CHR'", 
			"'AT'", "'READLN'", "'READ'", "'WRITELN'", "'WRITE'"
		};
	}
	private static final String[] _LITERAL_NAMES = makeLiteralNames();
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "BEGIN", "END", "WS", "COMMENT", "INTEGER", "CHAR", "STRING", "ASSIGN", 
			"PLUS", "MINUS", "DIV", "MULT", "MOD", "AND", "NOT", "OR", "GT", "LT", 
			"LE", "GE", "EQUAL", "NOT_EQUAL", "L_PAREN", "R_PAREN", "L_BRACK", "R_BRACK", 
			"COMMA", "SEMICOLON", "COLON", "DOT", "DOUBLE_DOT", "PROGRAM", "FUNCTION", 
			"PROCEDURE", "IF", "THEN", "ELSE", "UNTIL", "WHILE", "FOR", "REPEAT", 
			"TO", "DO", "DOWNTO", "VAR", "TRUE", "FALSE", "ARRAY", "OF", "INTEGER_", 
			"BOOLEAN_", "CHAR_", "STRING_", "NIL", "CONST", "CHR", "AT", "READLN", 
			"READ", "WRITELN", "WRITE", "ID"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 36064007160856576L) != 0)) {
				{
				setState(176);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
